...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        #     # of mongo queries,
        # )
        ('no_overrides', 1, True, False): (28, 1),
        ('no_overrides', 2, True, False): (28, 1),
        ('no_overrides', 3, True, False): (28, 1),
        ('ccx', 1, True, False): (28, 1),
        ('ccx', 2, True, False): (28, 1),
        ('ccx', 3, True, False): (28, 1),
        ('no_overrides', 1, False, False): (28, 1),
        ('no_overrides', 2, False, False): (28, 1),
        ('no_overrides', 3, False, False): (28, 1),
        ('ccx', 1, False, False): (28, 1),
        ('ccx', 2, False, False): (28, 1),
        ('ccx', 3, False, False): (28, 1),
    }
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (28, 3),
        ('no_overrides', 2, True, False): (28, 3),
        ('no_overrides', 3, True, False): (28, 3),
        ('ccx', 1, True, False): (28, 3),
        ('ccx', 2, True, False): (28, 3),
        ('ccx', 3, True, False): (28, 3),
        ('ccx', 1, True, True): (29, 3),
        ('ccx', 2, True, True): (29, 3),
        ('ccx', 3, True, True): (29, 3),
        ('no_overrides', 1, False, False): (28, 3),
        ('no_overrides', 2, False, False): (28, 3),
        ('no_overrides', 3, False, False): (28, 3),
        ('ccx', 1, False, False): (28, 3),
        ('ccx', 2, False, False): (28, 3),
        ('ccx', 3, False, False): (28, 3),
    }
